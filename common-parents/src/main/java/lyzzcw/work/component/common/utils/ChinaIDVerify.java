...
public class ChinaIDVerify {
	...
	public static void main(String[] args) throws ParseException {
		String IdCard="37230786235454";
		System.out.println(ChinaIDVerify.IDCardValidate(IdCard).get("code") + " : " + ChinaIDVerify.IDCardValidate(IdCard).get("message"));
