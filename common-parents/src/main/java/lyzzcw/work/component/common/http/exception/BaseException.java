package lyzzcw.work.component.common.http.exception;

import lombok.Data;
import lyzzcw.work.component.common.http.constant.status.BaseStatusCode;
import lyzzcw.work.component.common.http.constant.status.IStatusCode;
...
public class BaseException extends RuntimeException{
    ...
    public BaseException(Integer error, String msg) {
        super(msg);
        this.error = error;
        this.msg = msg;
        doFillInStackTrace();
