package lyzzcw.work.component.common.json.fastjson;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONArray;
import com.alibaba.fastjson2.JSONObject;
import com.alibaba.fastjson2.TypeReference;
import lyzzcw.work.component.common.json.exception.FastjsonException;
...
//    }
    ...
    public static HashMap<String, Object> fromMap(String json) {
        ...
        return JSON.parseObject(json,new TypeReference<HashMap<String, Object>>() {}.getType());
    }
     ...
     * @return byte, 默认为 0
     */
    public static Short getAsByte(String json, String key) {
        if (StringUtils.isEmpty(json)) {
            return 0;
        }
        try {
...
//    /**
//     * 格式化Json(美化) fastjson2 移除SerializerFeature类
//     * @return json
//     */
