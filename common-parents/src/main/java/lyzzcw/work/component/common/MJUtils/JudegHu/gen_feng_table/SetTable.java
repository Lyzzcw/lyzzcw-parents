package lyzzcw.work.component.common.MJUtils.JudegHu.gen_feng_table;
...
public class SetTable {
	...
	public void dump(String name) {
		...
		try {
			...
			Iterator<Entry<Integer, Boolean>> iter = m_tbl.entrySet()
					.iterator();
			while (iter.hasNext()) {
				Entry<Integer, Boolean> entry = (Entry<Integer, Boolean>) iter
						.next();
