package lyzzcw.work.component.minio.oss.enums;
...
public enum MinioTypeEnum {
     ...
     */
    MinioTypeEnum(String extension, String explain, String mimeType) {
     ...
     * @return 枚举类
     */
    public static MinioTypeEnum getByExtension(String extension) {
        if (StringUtils.isEmpty(extension)) {
            return null;
        }
        for (MinioTypeEnum typesEnum : MinioTypeEnum.values()) {
    ...
    public static String getContentType(String fileType) {
        MinioTypeEnum mimeTypeEnum = MinioTypeEnum.getByExtension(fileType);
